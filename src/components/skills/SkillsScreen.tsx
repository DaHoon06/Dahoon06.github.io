...
export const SkillsScreen = (): ReactElement => {
  ...
  return (
    <SkillsScreenLayout>
      <Title>Skills.</Title>
      <Tabs>
        <Tab isActive={activeTab === "Frontend"} onClick={() => setActiveTab("Frontend")}>
          Frontend
        </Tab>
        <Tab isActive={activeTab === "Backend"} onClick={() => setActiveTab("Backend")}>
          Backend
        </Tab>
        <Tab isActive={activeTab === "Etc"} onClick={() => setActiveTab("Etc")}>
          Etc
        </Tab>
      </Tabs>
      <SkillList>
